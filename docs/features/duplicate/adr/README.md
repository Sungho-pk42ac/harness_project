...
| #                                               | 제목                                                   | 상태     |
| ----------------------------------------------- | ------------------------------------------------------ | -------- |
| [0001](0001-reuse-addnote-return-created.md)    | 기존 `addNote` 재사용 + 반환을 `Promise<Note>`로 확장  | Accepted |
| [0002](0002-duplicate-context-app-selection.md) | 복제는 Context가 생성, App이 선택 이동(상태 경계 분리) | Accepted |
