...
| #                                         | 제목                                              | 상태     |
| ----------------------------------------- | ------------------------------------------------- | -------- |
| [0001](0001-soft-delete-data-model.md)    | 소프트 삭제 데이터 모델: `Note.deletedAt?` 마킹   | Accepted |
| [0002](0002-active-trashed-derivation.md) | 활성/삭제 파생(순수 함수)과 휴지통 화면 상태 경계 | Accepted |
